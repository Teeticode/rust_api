...
pub async fn send_verification_email(
    ...
    let template_path = "src/mail/templates/VerificationEmail.html";
...
pub async fn send_welcome_email(
    ...
    let subject = "Welcome to My Keja";
    let template_path = "src/mail/templates/WelcomeEmail.html";
...
pub async fn send_forgot_password_email(
    ...
    let template_path = "src/mail/templates/ResetPassword.html";
    let placeholders = vec![
        ("{{username}}".to_string(), username.to_string()),
